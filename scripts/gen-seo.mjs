...
header.site nav a{color:var(--amber)}
...
p.strat{font-size:13px;color:var(--ink);margin:4px 0 0;background:rgba(224,163,90,.07);border-left:2px solid var(--amber);border-radius:0 8px 8px 0;padding:8px 11px}
