...
const PATCHES=[
  ...
  {ver:"2.00.01",date:"28.08.2026",size:"Erster Hotfix nach dem Enhanced-Umbau, vier Punkte unter der einzigen Überschrift Patch-Details. Zwei der vier Punkte hängen unmittelbar an den Neuerungen aus 2.00.00: die arabische Textanzeige und die Lippensynchronisation der neu vertonten Zwischensequenzen. Der Mac-Start und die Bildrate stehen für sich.",features:[
    ...
    {cat:"Plattformen und Quelle",items:[
      "Alle sechs Plattformen (Steam PC, Steam Mac, PlayStation, XBOX, Epic Games Store, Mac App Store) sind einzeln mit dem Status <em>Patch jetzt verfügbar</em> aufgeführt.",
      "<b>Widerspruch zur Known-Issues-Seite:</b> Die offizielle Liste bekannter Probleme (boardNo 68) führt weiterhin einen Punkt zu <b>nicht angezeigten arabischen Hilfetexten und Tastenbelegungen</b>, obwohl dieser Patch die fehlerhafte arabische Textanzeige als behoben meldet. <span style='color:var(--gdim)'>Einordnung: Die Formulierungen sind nicht wortgleich, es können also zwei verschiedene Fehler sein. Die Known-Issues-Seite trägt im Fließtext noch den Stand 09.04.2026, obwohl sie nachweislich später bearbeitet wurde — ihr Pflegestand ist also selbst unklar, was den Widerspruch am ehesten erklärt. Dasselbe Muster gab es schon bei 1.14.00 mit einem Pet-Fehler.</span>",
